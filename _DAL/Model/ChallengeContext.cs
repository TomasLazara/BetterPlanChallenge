...
public partial class ChallengeContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
    {
        ...
        {
            optionsBuilder.UseNpgsql("host=104.197.55.31;Database=challenge;Port=5432;Username=challengeuser;Password=challengepass;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Compositioncategory>(entity =>
        {
            ...
            entity.HasIndex(e => e.Uuid, "uuidCompositionCategory_").IsUnique();
        ...
        modelBuilder.Entity<Compositionsubcategory>(entity =>
        {
            ...
            entity.HasIndex(e => e.Uuid, "uuidCompositionSubcategory_").IsUnique();
        ...
        modelBuilder.Entity<Currency>(entity =>
        {
            ...
            entity.HasIndex(e => e.Uuid, "currency_unique").IsUnique();
        ...
        modelBuilder.Entity<Currencyindicator>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.Sourcecurrencyid, e.Destinationcurrencyid, e.Date }, "currency_indicator_unique").IsUnique();
        ...
        modelBuilder.Entity<Financialentity>(entity =>
        {
            ...
            entity.HasIndex(e => e.Uuid, "uuidFinancialEntity_").IsUnique();
        ...
        modelBuilder.Entity<Funding>(entity =>
        {
            ...
            entity.HasIndex(e => e.Uuid, "uuidFunding_").IsUnique();
        ...
        modelBuilder.Entity<Fundingsharevalue>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.Fundingid, e.Date }, "funding_share_value_unique").IsUnique();
        ...
        modelBuilder.Entity<Goalcategory>(entity =>
        {
            ...
            entity.HasIndex(e => e.Uuid, "uuidGoalCategory_").IsUnique();
        ...
        modelBuilder.Entity<Investmentstrategy>(entity =>
        {
            ...
            entity.HasIndex(e => e.Code, "IX_investmentstrategy_code").IsUnique();
        ...
        modelBuilder.Entity<Investmentstrategytype>(entity =>
        {
            ...
            entity.HasOne(d => d.Financialentity).WithMany(p => p.Investmentstrategytypes).HasForeignKey(d => d.Financialentityid);
        });
        ...
        modelBuilder.Entity<Portfolio>(entity =>
        {
            ...
            entity.HasIndex(e => e.Uuid, "uuidPortfolio_").IsUnique();
        ...
        modelBuilder.Entity<Risklevel>(entity =>
        {
            ...
            entity.HasIndex(e => e.Code, "IX_risklevel_code").IsUnique();
